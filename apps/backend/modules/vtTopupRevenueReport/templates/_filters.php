...
<div class="row-fluid">
    <div class="span9">
      ...
      <div class="control-group">
              ...
              <form action="<?php echo url_for('vt_vpg_transaction_vtTopupRevenueReport_collection', array('action' => 'filter')) ?>" method="post">
                  <div class="span11">
                      ...
                      <?php include_partial('vtTopupRevenueReport/filters_field', array(
                      'name'       => $name,
                    ...
                    <div class="span2 button" style="height:50px">
                      ...
                      <?php echo link_to('<i class="icon-remove icon-black"></i> '. __('Hủy', array(), 'tmcTwitterBootstrapPlugin'), 'vt_vpg_transaction_vtTopupRevenueReport_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'btn')) ?></li>
