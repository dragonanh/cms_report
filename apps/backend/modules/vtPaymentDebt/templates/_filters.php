            ...
            <form action="<?php echo url_for('vt_payment_debt_collection', array('action' => 'filter')) ?>"
                ...
                <div class="span11">
                    ...
                    <div class="span2 button" style="height:50px">
                        ...
                        <?php echo link_to('<i class="icon-remove icon-black"></i> ' . __('Hủy', array(), 'tmcTwitterBootstrapPlugin'), 'vt_payment_debt_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'btn')) ?></li>
                        <input class="btn btn-primary" type="submit" name="export"
                               value="<?php echo __('Xuất báo cáo', array(), 'tmcTwitterBootstrapPlugin') ?>"/>
