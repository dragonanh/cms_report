 ...
 */
class VtOmniReportAdminFormFilter extends BaseVtCttTransactionFormFilter
{
  ...
  protected function doBuildQuery(array $values) {
    ...
    if (isset($values['sim_number']) && $values['sim_number'] !== '') {
      $query->andWhere('sim_number = ?', VtHelper::getMobileNumber($values['sim_number'], VtHelper::MOBILE_NOTPREFIX));
    }
