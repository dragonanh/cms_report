...
require_once dirname(__FILE__).'/../lib/vtPreToPostReportGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/vtPreToPostReportGeneratorHelper.class.php';

/**
 * vtPreToPostReport actions.
 *
 * @package    cms_ctt
 * @subpackage vtPreToPostReport
 * @author     viettel
 * @version    SVN: $Id: actions.class.php_bak.bak 23810 2009-11-12 11:07:44Z Kris.Wallsmith $
 */
class vtPreToPostReportActions extends autoVtPreToPostReportActions
{
    public function executeFilter(sfWebRequest $request)
    {
        ...
        if ($request->hasParameter('_reset'))
        {
            ...
            $this->redirect('@vt_ctt_transaction_vtPreToPostReport');
        }
    ...
    public function exportExcel(){
        ...
        $sheet->setCellValue('A1', $i18n->__('THỐNG KÊ GIAO DỊCH CHUYỂN ĐỔI SANG TRẢ SAU'));
        ...
        $sheet->setCellValue('C5', $i18n->__('Số thuê bao chuyển đổi'));
        ...
        $sheet->setCellValue('G5', $i18n->__('Trạng thái chuyển đổi'));
        ...
        $fileName = 'pre_to_post_report_'.date('YmdHis').'.xlsx';
