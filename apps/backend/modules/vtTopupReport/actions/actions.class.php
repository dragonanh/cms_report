...
require_once dirname(__FILE__).'/../lib/vtTopupReportGeneratorConfiguration.class.php';
require_once dirname(__FILE__).'/../lib/vtTopupReportGeneratorHelper.class.php';

/**
 * vtTopupReport actions.
 *
 * @package    cms_ctt
 ...
 */
class vtTopupReportActions extends autoVtTopupReportActions
{
  public function executeFilter(sfWebRequest $request)
  {
    ...
    if ($request->hasParameter('_reset'))
    {
      ...
      $this->redirect('@vt_ctt_transaction_vtTopupReport');
    }
  ...
  public function exportExcel(){
    ...
    $sheet->setCellValue('A1', $i18n->__('THỐNG KÊ GIAO DỊCH TOPUP'));
    ...
    $sheet->setCellValue('C5', $i18n->__('Số thuê bao được topup'));
    ...
    $sheet->setCellValue('G5', $i18n->__('Trạng thái gạch nợ/nạp tiền'));
    ...
    foreach ($results as $key => $result){
      ...
      $sheet->setCellValue("F$startRow", $result->getChannelName());
