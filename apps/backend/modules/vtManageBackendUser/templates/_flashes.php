<?php if ($sf_user->hasFlash('success')): ?>
    <div class="alert alert-success fade in">
        ...
        <?php if($sf_user->hasFlash('fileImportFail')):?>
            <a href="<?php echo url_for('sf_guard_download_fail_file', array('file_name' => $sf_user->getFlash('fileImportFail')))?>">tải file</a>
            <?php $sf_user->setAttribute('fileImportFail', 'true', 'symfony/user/sfUser/flash/remove') ?>
        <?php endif?>
        <?php if($sf_user->hasFlash('fileImportCancelFail')):?>
            <a href="<?php echo url_for('sf_guard_download_cancel_fail_file', array('file_name' => $sf_user->getFlash('fileImportCancelFail')))?>">tải file</a>
            <?php $sf_user->setAttribute('fileImportCancelFail', 'true', 'symfony/user/sfUser/flash/remove') ?>
        <?php endif?>
    </div>
