                ...
                <div class="span11">
                    ...
                    <div class="span2 button" style="height:50px">
                        <input class="btn" type="submit"
                               value="<?php echo __('Tìm kiếm', array(), 'tmcTwitterBootstrapPlugin') ?>"/>
                        <?php echo link_to('<i class="icon-remove icon-black"></i> ' . __('Hủy', array(), 'tmcTwitterBootstrapPlugin'), 'partner_transaction_PartnerTransactionReport_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'btn')) ?></li>
                        <input class="btn btn-primary" type="submit" name="export"
                               value="<?php echo __('Xuất Excel', array(), 'tmcTwitterBootstrapPlugin') ?>"/>
                        ...
                        <tr>
                            ...
                            <td><br>
                                <button class="btn btn-warning" type="submit" name="_import"><i
                                            class="icon-upload icon-black"></i> Hoàn tiền
                                </button>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="span11" style="height:50px">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><br>
                                <button class="btn btn-warning" type="submit" name="_import"><i
                                            class="icon-upload icon-black"></i> Hoàn điểm
                                </button>
                            </td>
                        </tr>
                        <tr>
